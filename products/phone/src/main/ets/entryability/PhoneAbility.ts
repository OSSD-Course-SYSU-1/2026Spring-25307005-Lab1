...
export default class PhoneAbility extends UIAbility {
  ...
  onCreate(want: Want, launchParam: AbilityConstant.LaunchParam) {
    hilog.info(0x0000, 'testTag', '%{public}s', 'PhoneAbility onCreate');
  ...
  onDestroy() {
    hilog.info(0x0000, 'testTag', '%{public}s', 'PhoneAbility onDestroy');
  }

  onWindowStageCreate(windowStage: window.WindowStage) {
    hilog.info(0x0000, 'testTag', '%{public}s', 'PhoneAbility onWindowStageCreate');
  ...
  onWindowStageDestroy() {
    hilog.info(0x0000, 'testTag', '%{public}s', 'PhoneAbility onWindowStageDestroy');
  }

  onForeground() {
    hilog.info(0x0000, 'testTag', '%{public}s', 'PhoneAbility onForeground');
  }

  onBackground() {
    hilog.info(0x0000, 'testTag', '%{public}s', 'PhoneAbility onBackground');
  }

  // 迁移时系统自动调用 - 源端保存状态
  async onContinue(wantParam: Record<string, Object>): Promise<AbilityConstant.OnContinueResult> {
    hilog.info(0x0000, 'testTag', '%{public}s', 'PhoneAbility onContinue');
...
>>>>>>> ec2c3a8fa90320418457a7069fe965d421ef26be
  ...
  private handleDistributedData(want: Want) {
    hilog.info(0x0000, 'testTag', '%{public}s', 'PhoneAbility handleDistributedData');
...
>>>>>>> ec2c3a8fa90320418457a7069fe965d421ef26be
  ...
  onNewWant(want: Want, launchParam: AbilityConstant.LaunchParam) {
    hilog.info(0x0000, 'testTag', '%{public}s', 'PhoneAbility onNewWant');
